	<table cellspacing="0" class="table">
		<thead>
			<tr>
				...
				<th width="190"><?php echo lang('global:actions') ?></th>
			</tr>
		</thead>
		<tbody>
			<?php foreach ($blog as $post) : ?>
				<tr>
					...
					<td style="padding-top:10px;">
						...
						| <a href="<?php echo site_url('admin/blog/delete/' . $post->id) ?>" confirm-action title="<?php echo lang('global:delete')?>" class="button confirm"><?php echo lang('global:delete')?></a>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
