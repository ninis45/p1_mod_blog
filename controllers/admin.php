...
class Admin extends Admin_Controller
{
	...
	protected $validation_rules = array(
		'title' => array(
			...
			'rules' => 'trim|htmlspecialchars|required|max_length[300]|callback__check_title'
		),
		'slug' => array(
			'field' => 'slug',
	...
	public function index()
	{
		...
		$pagination = create_pagination('admin/blog/index', $total_rows,10);
		...
		$this->template
            ...
            ->append_js('module::blog.controller.js')
			->set('blog', $blog);
